...
The ambition was to extract 500 000 tweets created during the first week of November, 2019. The total number of tweets downloaded ended up in *407 976*.
...
The original file is *144 MB* large. To share the file, I used `split` to divide the file into *four* equal parts. This is the code used for splitting the data frame and then saving separate `.rds`.
